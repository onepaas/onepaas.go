...
/* ReadProjectParams contains all the parameters to send to the API endpoint
   for the read project operation.
...
// WithDefaults hydrates default values in the read project params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReadProjectParams) WithDefaults() *ReadProjectParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the read project params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ReadProjectParams) SetDefaults() {
...
func (o *ReadProjectParams) WithID(id string) *ReadProjectParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the read project params
func (o *ReadProjectParams) SetID(id string) {
	o.ID = id
}
